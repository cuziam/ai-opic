...
export default function Prepare({ children }) {
  ...
  //아래 pageinfo 부분은 따로 빼놔야 함. 일단 보류
  const pageinfo = {
    title: "Guide",
    descriptions: [
      "* Background Survey 화면입니다.",
      "* 선택하신 항목을 기초로 개인별 문항이 출제되니, 모든 설문에 빠짐없이 답변해 주십시오.",
      "* Part 4에서는 총 12개 이상의 항목을 선택해야 합니다.",
      "* 시험 문항은 설문에 포함되지 않은 일반 주제의 질문도 출제되니 유의바랍니다.",
    ],
    onClose: handleClose,
  };
