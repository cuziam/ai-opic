...
export default function Welcome() {
  ...
  const pageinfo = {
    ...
    descriptions: [
      "* 시험 시작 안내 화면입니다.",
      "* 휴대폰 전원을 차단해 주시고, 신분증을 제외한 모든 개인 소지품(필기도구, 책, 메모지, 휴대폰 등)은 책상 아래로 내려놓아 주십시오.",
      "* 각 단계는 임의로 진행하지 마시고, 반드시 감독관의 안내에 따라 시험을 진행하여 주시기 바랍니다.",
    ],
    onClose: handleClose,
  };
  return (
    <div>
      <div className="bg-white p-4 w-full">
        ...
        <div className="Interviewer flex flex-col justify-center items-center">
          <div className="mb-4">
            <img
          ...
          <p className="text-gray-700">본 인터뷰 평가의 진행자는 Ava 입니다.</p>
          <Link
